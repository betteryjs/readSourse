...
// 删除 prev_node 和 next_node 之间的节点
 ...
 */
 // remove the node in the list and insert in  list's head
 ...
 */
 // remove node and  insert in the list's tail
...
// (char *)(ptr) 计算字节偏移
//  Task taskPos= list_entry(pos,struct Task,entry_list);
